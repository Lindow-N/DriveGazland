"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{Ab:function(){return sV},EK:function(){return P},ET:function(){return sb},IO:function(){return su},JU:function(){return iV},PL:function(){return sA},QT:function(){return sC},Xo:function(){return sm},ad:function(){return iP},ar:function(){return sc},cf:function(){return sD},hJ:function(){return iL},pl:function(){return sN},r7:function(){return sk},vr:function(){return sL}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let iQ=/^__.*__$/;class ij{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return null!==this.fieldMask?new tq(e,this.data,this.fieldMask,t,this.fieldTransforms):new tU(e,this.data,t,this.fieldTransforms)}}class iW{constructor(e,t,n){this.data=e,this.fieldMask=t,this.fieldTransforms=n}toMutation(e,t){return new tq(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function iH(e){switch(e){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw I()}}class iY{constructor(e,t,n,r,i,s){this.settings=e,this.databaseId=t,this.serializer=n,this.ignoreUndefinedProperties=r,void 0===i&&this.yu(),this.fieldTransforms=i||[],this.fieldMask=s||[]}get path(){return this.settings.path}get wu(){return this.settings.wu}Su(e){return new iY(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}bu(e){var t;let n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Su({path:n,Du:!1});return r.vu(e),r}Cu(e){var t;let n=null===(t=this.path)||void 0===t?void 0:t.child(e),r=this.Su({path:n,Du:!1});return r.yu(),r}Fu(e){return this.Su({path:void 0,Du:!0})}Mu(e){return st(e,this.settings.methodName,this.settings.xu||!1,this.path,this.settings.Ou)}contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}yu(){if(this.path)for(let e=0;e<this.path.length;e++)this.vu(this.path.get(e))}vu(e){if(0===e.length)throw this.Mu("Document fields must not be empty");if(iH(this.wu)&&iQ.test(e))throw this.Mu('Document fields cannot begin and end with "__"')}}class iX{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||n6(e)}Nu(e,t,n,r=!1){return new iY({wu:e,methodName:t,Ou:n,path:z.emptyPath(),Du:!1,xu:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function iJ(e){let t=e._freezeSettings(),n=n6(e._databaseId);return new iX(e._databaseId,!!t.ignoreUndefinedProperties,n)}function iZ(e,t,n,r,i,s={}){let a,o;let l=e.Nu(s.merge||s.mergeFields?2:0,t,n,i);i5("Data must be an object, but it was:",l,r);let u=i9(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i6(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);sn(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new ij(new eO(u),a,o)}class i0 extends iz{_toFieldTransform(e){if(2!==e.wu)throw 1===e.wu?e.Mu(`${this._methodName}() can only appear at the top level of your update data`):e.Mu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof i0}}function i1(e,t,n){return new iY({wu:3,Ou:t.settings.Ou,methodName:e._methodName,Du:n},t.databaseId,t.serializer,t.ignoreUndefinedProperties)}class i2 extends iz{constructor(e,t){super(e),this.Lu=t}_toFieldTransform(e){let t=i1(this,e,!0),n=new tC(this.Lu.map(e=>i4(e,t)));return new tR(e.path,n)}isEqual(e){return e instanceof i2&&(0,h.vZ)(this.Lu,e.Lu)}}class i3 extends iz{constructor(e,t){super(e),this.Lu=t}_toFieldTransform(e){let t=i1(this,e,!0),n=new tA(this.Lu.map(e=>i4(e,t)));return new tR(e.path,n)}isEqual(e){return e instanceof i3&&(0,h.vZ)(this.Lu,e.Lu)}}function i4(e,t){if(i8(e=(0,h.m9)(e)))return i5("Unsupported field value:",t,e),i9(e,t);if(e instanceof iz)return function(e,t){if(!iH(t.wu))throw t.Mu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.Mu(`${e._methodName}() is not currently supported inside arrays`);let n=e._toFieldTransform(t);n&&t.fieldTransforms.push(n)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),e instanceof Array){if(t.settings.Du&&4!==t.wu)throw t.Mu("Nested arrays are not supported");return function(e,t){let n=[],r=0;for(let i of e){let e=i4(i,t.Fu(r));null==e&&(e={nullValue:"NULL_VALUE"}),n.push(e),r++}return{arrayValue:{values:n}}}(e,t)}return function(e,t){var n,r,i;if(null===(e=(0,h.m9)(e)))return{nullValue:"NULL_VALUE"};if("number"==typeof e)return n=t.serializer,"number"==typeof(i=r=e)&&Number.isInteger(i)&&!J(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER?t_(r):tw(n,r);if("boolean"==typeof e)return{booleanValue:e};if("string"==typeof e)return{stringValue:e};if(e instanceof Date){let n=P.fromDate(e);return{timestampValue:na(t.serializer,n)}}if(e instanceof P){let n=new P(e.seconds,1e3*Math.floor(e.nanoseconds/1e3));return{timestampValue:na(t.serializer,n)}}if(e instanceof iK)return{geoPointValue:{latitude:e.latitude,longitude:e.longitude}};if(e instanceof iB)return{bytesValue:no(t.serializer,e._byteString)};if(e instanceof iR){let n=t.databaseId,r=e.firestore._databaseId;if(!r.isEqual(n))throw t.Mu(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);return{referenceValue:nu(e.firestore._databaseId||t.databaseId,e._key.path)}}if(e instanceof iG)return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:e.toArray().map(e=>{if("number"!=typeof e)throw t.Mu("VectorValues must only contain numeric values.");return tw(t.serializer,e)})}}}}};throw t.Mu(`Unsupported field value: ${iA(e)}`)}(e,t)}function i9(e,t){let n={};return et(e)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):ee(e,(e,r)=>{let i=i4(r,t.bu(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function i8(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof P||e instanceof iK||e instanceof iB||e instanceof iR||e instanceof iz||e instanceof iG)}function i5(e,t,n){if(!i8(n)||!("object"==typeof n&&null!==n&&(Object.getPrototypeOf(n)===Object.prototype||null===Object.getPrototypeOf(n)))){let r=iA(n);throw"an object"===r?t.Mu(e+" a custom object"):t.Mu(e+" "+r)}}function i6(e,t,n){if((t=(0,h.m9)(t))instanceof i$)return t._internalPath;if("string"==typeof t)return se(e,t);throw st("Field path arguments must be of type string or ",e,!1,void 0,n)}let i7=RegExp("[~\\*/\\[\\]]");function se(e,t,n){if(t.search(i7)>=0)throw st(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,!1,void 0,n);try{return new i$(...t.split("."))._internalPath}catch(r){throw st(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,!1,void 0,n)}}function st(e,t,n,r,i){let s=r&&!r.isEmpty(),a=void 0!==i,o=`Function ${t}() called with invalid data`;n&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${r}`),a&&(l+=` in document ${i}`),l+=")"),new S(C.INVALID_ARGUMENT,o+e+l)}function sn(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sC(e){e=iN(e,iR);let t=iN(e.firestore,iF);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new im({next:s=>{t.enqueueAndForget(()=>rB(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rG(e5(n.path),s,{includeMetadataChanges:!0,_a:!0});return rq(e,a)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(iU(t),e._key).then(n=>sx(t,e,n))}class sS extends sv{constructor(e){super(),this.firestore=e}convertBytes(e){return new iB(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iR(this.firestore,null,t)}}function sA(e){e=iN(e,iD);let t=iN(e.firestore,iF),n=iU(t),r=new sS(t);return sa(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new rG(n,new im({next:n=>{t.enqueueAndForget(()=>rB(e,s)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),{includeMetadataChanges:!0,_a:!0});return rq(e,s)})(await i_(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new sI(t,r,e,n))}function sN(e,t,n){e=iN(e,iR);let r=iN(e.firestore,iF),i=sw(e.converter,t,n);return sR(r,[iZ(iJ(r),"setDoc",e._key,i,null!==e.converter,n).toMutation(e._key,tL.none())])}function sk(e,t,n,...r){e=iN(e,iR);let i=iN(e.firestore,iF),s=iJ(i);return sR(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof i$?function(e,t,n,r,i,s){let a=e.Nu(1,t,n),o=[i6(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i6(t,s[e])),l.push(s[e+1]);let u=[],c=eO.empty();for(let e=o.length-1;e>=0;--e)if(!sn(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Cu(t);if(n instanceof i0)u.push(t);else{let e=i4(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iW(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Nu(1,t,n);i5("Data must be an object, but it was:",i,r);let s=[],a=eO.empty();return ee(r,(e,r)=>{let o=se(t,e,n);r=(0,h.m9)(r);let l=i.Cu(o);if(r instanceof i0)s.push(o);else{let e=i4(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iW(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tL.exists(!0))])}function sb(e,t){let n=iN(e.firestore,iF),r=iV(e),i=sw(e.converter,t);return sR(n,[iZ(iJ(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,tL.exists(!1))]).then(()=>r)}function sD(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iO(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iO(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof iR)a=iN(e.firestore,iF),o=e5(e._key.path),s={next:n=>{t[u]&&t[u](sx(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iN(e,iD);a=iN(n.firestore,iF),o=n._query;let r=new sS(a);s={next:e=>{t[u]&&t[u](new sI(a,r,n,e))},error:t[u+1],complete:t[u+2]},sa(e._query)}return function(e,t,n,r){let i=new im(r),s=new rG(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rq(await i_(e),s)),()=>{i.za(),e.asyncQueue.enqueueAndForget(async()=>rB(await i_(e),s))}}(iU(a),o,c,s)}function sR(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r4(await iw(e).then(e=>e.syncEngine),t,n)),n.promise}(iU(e),t)}function sx(e,t,n){let r=n.docs.get(t._key),i=new sS(e);return new sE(e,i,t._key,r,new s_(n.hasPendingWrites,n.fromCache),t.converter)}function sL(...e){return new i2("arrayUnion",e)}function sV(...e){return new i3("arrayRemove",e)}new WeakMap,function(e=!0){g=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iF(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.0",void 0),(0,o.KN)(m,"4.7.0","esm2017")}()}}]);